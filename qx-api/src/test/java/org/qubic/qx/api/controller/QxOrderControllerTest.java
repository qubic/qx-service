...
import org.qubic.qx.api.controller.domain.QxOrderTemplate;
...
class QxOrderControllerTest {
    ...
    void addBid() {
        ...
        QxOrderTemplate expected = new QxOrderTemplate(TICK_NUMBER, FROM_ID,  Qx.ADDRESS, 6, TOTAL_AMOUNT,
        ...
        client.post().uri("/issuer/ISSUER/asset/ASSET/add-bid")
                ...
                .exchange()
                .expectStatus().isOk()
                .expectBody(QxOrderTemplate.class)
                .isEqualTo(expected);
    }
    ...
    void addAsk() {
        ...
        QxOrderTemplate expected = new QxOrderTemplate(TICK_NUMBER, FROM_ID,  Qx.ADDRESS, 5, BigInteger.ONE,
                "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABBU1NFVAAAACoAAAAAAAAAAwAAAAAAAAA=");
    ...
    void removeBid() {
        ...
        QxOrderTemplate expected = new QxOrderTemplate(TICK_NUMBER, FROM_ID,  Qx.ADDRESS, 8, BigInteger.ONE,
                "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABBU1NFVAAAACoAAAAAAAAAAwAAAAAAAAA=");
    ...
    void removeAsk() {
        ...
        QxOrderTemplate expected = new QxOrderTemplate(TICK_NUMBER, FROM_ID,  Qx.ADDRESS, 7, BigInteger.ONE,
                "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABBU1NFVAAAACoAAAAAAAAAAwAAAAAAAAA=");
